...
function printDepartments(departments: Department[]) {
  ...
  console.log(
    `  ${"ID".padEnd(24)} ${"NAME".padEnd(25)} DESCRIPTION`
  );
  console.log("  " + "─".repeat(70));
  ...
  for (const dept of departments) {
    ...
    console.log(
      `  ${dept.id.padEnd(24)} ${truncatedName.padEnd(25)} ${description}`
    );
  }
...
function printDepartmentDetail(department: Department) {
