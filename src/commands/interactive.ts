...
function ensureConfig(): ValidConfig {
...
async function roadmapsMenu(): Promise<void> {
  const config = ensureConfig();
...
async function workflowsMenu(): Promise<void> {
  const config = ensureConfig();
...
async function listWorkflows(config: ValidConfig): Promise<void> {
  try {
...
async function createWorkflow(config: ValidConfig): Promise<void> {
  try {
    const name = await input({
...
async function ideasMenu(): Promise<void> {
  const config = ensureConfig();
...
async function vmSessionsMenu(): Promise<void> {
  const config = ensureConfig();
...
async function listVMSessions(config: ValidConfig): Promise<void> {
  try {
    ...
    const sessions: VMSession[] = data.sessions || [];
...
async function julesSessionsMenu(): Promise<void> {
  const config = ensureConfig();
...
async function listJulesSources(config: ValidConfig): Promise<void> {
  try {
...
async function strategyMenu(): Promise<void> {
  const config = ensureConfig();
...
async function showStrategy(config: ValidConfig): Promise<void> {
  try {
    ...
    interface Value { id: string; name: string; description?: string; }
...
async function updateVision(config: ValidConfig): Promise<void> {
  try {
    const vision = await input({
...
async function updateMission(config: ValidConfig): Promise<void> {
  try {
